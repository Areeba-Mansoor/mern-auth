...
const s = {
  ...
  card: { background: '#fff', padding: '2rem', borderRadius: '12px', boxShadow: '0 2px 16px rgba(0,0,0,0.08)', width: '100%', maxWidth: '400px' },
  title: { fontSize: '22px', fontWeight: '500', marginBottom: '4px' },
  sub: { fontSize: '14px', color: '#888', marginBottom: '1.5rem' },
  error: { backgroundColor: '#fff0f0', color: '#cc0000', padding: '10px 14px', borderRadius: '8px', fontSize: '13px', marginBottom: '1rem' },
  ...
  btn: { marginTop: '0.5rem', padding: '11px', borderRadius: '8px', border: 'none', backgroundColor: '#4F46E5', color: '#fff', fontSize: '14px', fontWeight: '500', cursor: 'pointer' },
